"""
NeRF 3D reconstruction - Practice Code
...
def main(demo: bool = False, device: str = "cpu"):
    print(f"=== NeRF 3D reconstruction Practice ===")
    ...
    metrics = {
        "keyword": "NeRF 3D reconstruction",
        "device": device,
        "demo": demo,
        "image_size": [h, w],
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="NeRF 3D reconstruction Practice")
