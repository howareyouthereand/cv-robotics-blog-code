"""
카메라 내부 파라미터 캘리브레이션 - Practice Code
...
def main(demo: bool = False, device: str = "cpu"):
    print(f"=== 카메라 내부 파라미터 캘리브레이션 Practice ===")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="카메라 내부 파라미터 캘리브레이션 Practice")
